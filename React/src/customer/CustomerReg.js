    ...
    const validateData = (name, value) => {
        ...
        switch (name) {
            ...
            case 'confirmpassword':
                ...
                break;
            case 'contact': var pattern = /^[0-9]{10}$/
                if (pattern.test(value)) {
                    valid = true;
                    error = "";
                }
                ...
                break;
            case 'line_1': var pattern = /^[A-Za-z0-9'\.\-\s\,]{1,200}$/
                if (pattern.test(value)) {
                    valid = true;
                    error = "";
                }
                ...
                break;
            case 'line_2': var pattern = /^[A-Za-z0-9'\.\-\s\,]{1,200}$/
                if (pattern.test(value)) {
                    valid = true;
                    error = "";
                }
                ...
                break;
            case 'city': var pattern = /^[#.0-9a-zA-Z\s,-]+$/
                if (pattern.test(value)) {
                    valid = true;
                    error = "";
                }
                ...
                break;
            case 'state': var pattern = /^[#.a-zA-Z\s,-]+$/
                if (pattern.test(value)) {
                    valid = true;
                    error = "";
                }
            ...
            <form>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" name="type_id" id="inputFname" value="Customer" />
                    </div>
                </div>
